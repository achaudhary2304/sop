...
def sir_simulation(args):
    G, patient_zero, beta, gamma, max_iter = args
...
with Pool() as p:
    sir_labels = np.array(p.map(sir_simulation, [(G_khop, i, 0.3, 0.1, 50) for i in range(num_users)]))
